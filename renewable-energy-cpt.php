...
function renewable_energy_register_slides_posttype_init() {
    /**
...
add_action('init', 'renewable_energy_register_slides_posttype_init');

// Create Projects Post Type
function renewable_energy_register_projects_posttype_init() {
    /**
     * add the projects custom post type
     * https://codex.wordpress.org/Function_Reference/register_post_type
     */
